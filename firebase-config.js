...
(()=>{
 ...
 window.addEventListener('load',()=>{
   load('./credit-client-save-fix.js?v=3&b=20260916').catch(()=>{});
   load('./proposal-share-fix.js?v=4&b=20260916').catch(()=>{});
   load('./credit-detail-share-fix.js?v=4&b=20260916').catch(()=>{});
   load('./cloud-credit-consistency-v1.js?v=1&b=20260916').catch(()=>{});
   load('./cloud-route-credit-sync-v1.js?v=2&b=20260916').catch(()=>{});
   load('./credit-detail-share-button-v1.js?v=1&b=20260916').catch(()=>{});
   load('./data-integrity-core-v1.js?v=1&b=20260914').catch(()=>{});
load('./credit-owner-repair-v4.js?v=2&b=20260916').catch(()=>{});
 });
})();
