...
const SHELL=[
  ...
  './self-check.js','./preflight-ui.js','./preflight.js','./pilot-config.js',
  './firebase-v2-template.js','./firebase-bootstrap.js',
  './operational-shell.html','./operational-controller.js',
  ...
  '../core/sync-errors.js','../core/offline-operation-queue.js','../core/transaction-store.js',
  '../cloud/firestore-atomic-adapter.js','../cloud/operational-sync.js','../cloud/runtime-cloud.js'
];
