// Mi Cartera PRO V2 — Firebase modular bootstrap for read-only pilot preflight.
// This module exposes only the minimum read capability required to verify the isolated V2 marker.
...
try{
  ...
  root.firebaseSdkV2={appSdk,fsSdk,app};root.firestoreV2={db,doc:fsSdk.doc,getDoc:fsSdk.getDoc};
