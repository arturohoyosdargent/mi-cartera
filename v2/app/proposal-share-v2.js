...
(function(root){
  ...
  async function share(){
    ...
    const hasPhone=Boolean(String(client?.phone||'').trim());if(hasPhone&&root.MiCarteraV2CustomerExperience?.whatsapp){try{root.MiCarteraV2CustomerExperience.whatsapp(client,text);return 'whatsapp'}catch(e){console.warn('V2 direct WhatsApp share failed; continuing with fallback.',e)}}
