...
(function(root){
  ...
  function proposal(d,c){
    ...
    x.fillStyle='#edf9f0';round(x,36,d.kind==='renewal'?694:650,648,84,18);x.strokeStyle='#187536';x.lineWidth=3;x.beginPath();x.moveTo(70,712);x.lineTo(70,681);x.quadraticCurveTo(53,686,56,671);x.quadraticCurveTo(72,671,70,688);x.quadraticCurveTo(87,684,88,669);x.quadraticCurveTo(71,671,70,693);x.stroke();txt(x,'Tu esfuerzo de hoy construye nuevas oportunidades.',100,d.kind==='renewal'?732:688,16,true,'#187536');txt(x,'Pequeños pasos, grandes logros.',100,d.kind==='renewal'?758:714,14,false,'#187536');
    const yShift=d.kind==='renewal'?44:0;txt(x,'Primeras cuotas',58,782+yShift,19,true);txt(x,'#',58,816+yShift,13,true);txt(x,'Fecha',112,816+yShift,13,true);txt(x,'Cuota',340,816+yShift,13,true);txt(x,'Saldo',535,816+yShift,13,true);
