...
(function(root){
  ...
  function proposal(d,c){
    ...
    x.fillStyle='#1197dc';round(x,18,18,684,126,18);x.strokeStyle='#fff';x.lineWidth=3;x.strokeRect(42,43,24,18);x.beginPath();x.moveTo(48,49);x.lineTo(60,49);x.moveTo(48,56);x.lineTo(57,56);x.stroke();txt(x,'PRÉSTAMO YA',78,62,29,true,'#fff');txt(x,'Tu aliado en soluciones financieras',42,91,14,false,'#fff');txt(x,'PROPUESTA DE CRÉDITO',42,123,16,true,'#fff');
