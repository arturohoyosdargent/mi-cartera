...
(async()=>{
  try{
    const cleanKey='prestamo_ya_cache_clean_v12';
    ...
    await loadScript('./backup.js?v=12');
    const core=document.createElement('script');core.type='module';core.src='./firebase-cloud-core.js?v=41';document.head.appendChild(core);
    await loadScript('./cloud-repair.js?v=10','module');
    await loadScript('./session-switch.js?v=1');
    await loadScript('./data-integrity.js?v=1');
    const installGuards=()=>{
