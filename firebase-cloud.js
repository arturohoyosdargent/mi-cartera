...
(async()=>{
  try{
    const cleanKey='prestamo_ya_cache_clean_v11';
    ...
    await loadScript('./backup.js?v=11');
    const core=document.createElement('script');core.type='module';core.src='./firebase-cloud-core.js?v=40';document.head.appendChild(core);
    await loadScript('./cloud-repair.js?v=9','module');
