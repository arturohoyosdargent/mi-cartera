...
(async()=>{
  try{
    const cleanKey='prestamo_ya_cache_clean_v10';
    ...
    await loadScript('./backup.js?v=10');
    const core=document.createElement('script');core.type='module';core.src='./firebase-cloud-core.js?v=39';document.head.appendChild(core);
    await loadScript('./cloud-repair.js?v=8','module');
    const installGuards=()=>{
